...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$errors) {
        $stmt = $pdo->prepare("UPDATE authors SET last_name=?, first_name=?, birth_date=?, country=? WHERE id=?");
        $stmt->execute([$last_name, $first_name, $birth_date ?: null, $country ?: null, $id]);
...
<div class="row justify-content-center">
    <div class="col-md-8 col-lg-7">
        <div class="card shadow-sm mt-4 mb-4">
            <h2 class="text-center mb-4" style="color:#FFA500;">Edit Author</h2>
            <?php if ($errors): ?>
